...
if __name__ == "__main__":
    ...
    train = 'S2298/OK_S2298'  #S350
    # train = 'OK_S2647_2/OK_S2647'  #肌红蛋白
    # train = 'OK_S2647_3/OK_S2647'  #Ssym
    # train = 'OK_S2647_4/OK_S2647'  #S611
    # train = 'OK_S2647_5/OK_S2647'  #p53
    ...
    test = 'OK_S350/OK_S350_1/OK_S350'
    # test = 'OK_Ssym/OK_Ssym_1/OK_Ssym'
    # test = 'OK_p53/OK_p53_1/OK_p53'
    # test = 'OK_Myoglobin/OK_Myoglobin_1/OK_Myoglobin'
    # test = 'OK_S669/OK_S669_1/OK_S669'
    ...
    test_keys = list(zip(keys, pssm_features_list, trans_wild_features_list, trans_mut_features_list, ddG, test_zone))
    test_keys = shuffle_dataset(test_keys, 1234)
    test_dataset = Dataset(test_keys, args.test_data_fpath, args.test_wild_pdb)
    ...
    for epochs in range(300):
        ...
        if epochs == 299:
            name = 'S2298-S350-two-direct'  #训练集-测试集-正向或反向-只有>0或只有<0或完整数据
